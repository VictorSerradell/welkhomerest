    ...
    return he(this, a3), ve(ke(s3 = o.call(this, t4)), "getPreSelection", function() {
      ...
      if (!s3.props.onChangeRaw || (s3.props.onChangeRaw.apply(ke(s3), t5), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        ...
        var o2, a4, i2, p, c2, l, d3, u2, h3 = (o2 = n.target.value, a4 = s3.props.dateFormat, i2 = s3.props.locale, p = s3.props.strictParsing, c2 = s3.props.minDate, l = null, d3 = Ge(i2) || Ge($e()), u2 = true, Array.isArray(a4) ? (a4.forEach(function(e4) {
          var t6 = parse(o2, e4, /* @__PURE__ */ new Date(), { locale: d3 });
          p && (u2 = Ie(t6, c2) && o2 === Oe(t6, e4, i2)), Ie(t6, c2) && u2 && (l = t6);
        }), l) : (l = parse(o2, a4, /* @__PURE__ */ new Date(), { locale: d3 }), p ? u2 = Ie(l) && o2 === Oe(l, a4, i2) : Ie(l) || (a4 = a4.match(xe).map(function(e4) {
          var t6 = e4[0];
          return "p" === t6 || "P" === t6 ? d3 ? (0, Pe[t6])(e4, d3.formatLong) : t6 : e4;
        }).join(""), o2.length > 0 && (l = parse(o2, a4.slice(0, o2.length), /* @__PURE__ */ new Date())), Ie(l) || (l = new Date(o2))), Ie(l) && u2 ? l : null));
